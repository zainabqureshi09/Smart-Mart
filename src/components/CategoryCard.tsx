...
export function CategoryCard({ category, variant = "default" }: CategoryCardProps) {
  ...
  if (variant === "compact") {
    return (
      ...
      >
        <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-muted flex items-center justify-center text-3xl md:text-4xl group-hover:scale-110 transition-transform">
          {category.icon}
        </div>
